<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerInfo.aspx.cs" Inherits="PMSystem.PerInfo" %>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-primary">
                                    <div class="panel-heading">
                                        <h1>
                                            <asp:Label ID="Label1" runat="server" Text="个人信息：" Font-Bold="True" Font-Size="XX-Large"></asp:Label>
                                        </h1>
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <table style="width: 38%;">
                                                        <tr align="left">
                                                            <td>
                                                                <asp:Label ID="employee" runat="server" Text="职员信息：" Font-Bold="True" Font-Size="XX-Large"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr align="left">
                                                            <td>&nbsp;</td>
                                                        ...
                                                        <tr align="left">
                                                            <td>
                                                                <asp:Label ID="eid" runat="server" Text="员工代号：" Font-Size="Large"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr align="left">
                                                            <td>
                                                                <asp:Label ID="ename" runat="server" Text="员工姓名：" Font-Size="Large"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                                <asp:Label ID="departID" runat="server" Text="所属部门：" Font-Size="Large"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr align="left">
                                                            <td>
                                                                <asp:Label ID="age" runat="server" Text="年 龄 ：" Font-Size="Large"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr align="left">
                                                            <td>
                                                                <asp:Label ID="password" runat="server" Text="登入密码：" Font-Size="Large"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr align="left">
                                                            <td class="auto-style3">
                                                                <asp:Label ID="permission" runat="server" Text="权 限 ：" Font-Size="Large"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr align="left">
                                                            <td>&nbsp;</td>
                                                        ...
                                                        <tr align="left">
                                                            <td>
                                                                <asp:Label ID="department" runat="server" Text="部门信息：" Font-Bold="True" Font-Size="XX-Large"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr align="left">
                                                            <td>&nbsp;</td>
                                                        ...
                                                        <tr align="left">
                                                            <td>
                                                                <asp:Label ID="did" runat="server" Text="部门代号：" Font-Size="Large"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr align="left">
                                                            <td>
                                                                <asp:Label ID="dname" runat="server" Text="部门名称：" Font-Size="Large"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr align="left">
                                                            <td>
                                                                <asp:Label ID="director" runat="server" Text="部门主管：" Font-Size="Large"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr align="left">
                                                            <td>&nbsp;</td>
