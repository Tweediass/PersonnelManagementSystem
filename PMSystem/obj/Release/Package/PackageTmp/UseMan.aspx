<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UseMan.aspx.cs" Inherits="PMSystem._default" %>
                                                ...
                                                <div>
                                                    <table class="auto-style8">
                                                        <tr>
                                                            ...
                                                            <td style="empty-cells: hide; border-collapse: separate;" rowspan="2">
                                                                <div class="auto-style28">
                                                                    <asp:GridView ID="GridView1" runat="server" Width="100%" Height="194px" CellPadding="4" ForeColor="#333333" GridLines="None">
                                                        ...
                                                        <tr>
                                                            <td class="auto-style20" colspan="2">
                                                                <asp:Button ID="Button4" runat="server" Text="删除" Font-Size="Medium" Width="64px" OnClick="Button4_Click" />
                                                                &nbsp&nbsp
                                                                <asp:Button ID="Button6" runat="server" Text="取消" Font-Size="Medium" Width="64px" OnClick="Button6_Click" />
                                                                &nbsp; &nbsp;<asp:Button ID="Button8" runat="server" Text="批量删除" Height="33px" OnClick="Button8_Click" Width="105px" />
                                                                <br />
                                                                <asp:Label ID="Label7" runat="server" Text="现在是删除用户模式"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
